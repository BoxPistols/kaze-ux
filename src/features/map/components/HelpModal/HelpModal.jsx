        ...
        return (
          <div className={styles.section}>
            ...
            <ol className={styles.stepList}>
              ...
              <li>
                「描画モード」でポリゴンを作成、または GeoJSON/KML をインポート
              </li>
            ...
            <table className={styles.table}>
              <tbody>
                <tr>
                  ...
                  <td>形状を編集</td>
                  <td>
                    サイドバーのアイコン、または地図上でダブルクリック・右クリックメニューから編集開始
                  </td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  ...
                  <td>削除</td>
                  <td>
                    サイドバーのアイコン、または地図上で右クリックメニューから削除
                  </td>
                </tr>
              </tbody>
            </table>
      ...
      case 'waypoint':
        return (
          <div className={styles.section}>
            ...
            <ul>
              <li>
                <strong>間隔:</strong> 5m〜200m
                で調整（スライダーまたは直接入力）
              </li>
              <li>
                <strong>頂点も含める:</strong> グリッドと頂点を両方生成
              </li>
              <li>
                <strong>プレビュー:</strong> 生成数を事前に確認
              </li>
            </ul>
            ...
            <ul>
              <li>
                <strong>サイドバーでダブルクリック:</strong>{' '}
                番号・緯度・経度を直接編集
              </li>
              <li>
                <strong>ドラッグ:</strong> マップ上でWaypointマーカーを移動
              </li>
              <li>
                <strong>削除:</strong>{' '}
                サイドバーのゴミ箱アイコン、または地図上で右クリックメニューから削除
              </li>
            </ul>
      ...
      case 'map':
        return (
          <div className={styles.section}>
            ...
            <p>
              飛行禁止区域は14カテゴリーに分類され、効率的な管理が可能です。
            </p>
            <table className={styles.table}>
              <tbody>
                <tr>
                  ...
                  <td>
                    グループ名の横のスイッチで、カテゴリー内の全施設を一括ON/OFF
                  </td>
                </tr>
                <tr>
                  <td className={styles.labelCell}>お気に入り</td>
                  <td>
                    ⭐アイコンでお気に入りに追加。よく使うグループを上部に固定表示
                  </td>
                </tr>
                <tr>
            ...
            <h3>施設詳細の表示</h3>
            <p>
              地図上の禁止区域施設（円形マーカー）をクリックすると、詳細情報をポップアップ表示します。
            </p>
            <ul>
              <li>
                <strong>基本情報:</strong> 施設名、種類、座標、制限半径
              </li>
              <li>
                <strong>原子力施設:</strong>{' '}
                稼働状況、原子炉数、発電容量、運営事業者
              </li>
              <li>
                <strong>その他施設:</strong> 所在地、カテゴリー、説明
              </li>
            </ul>
      ...
      case 'export':
        return (
          <div className={styles.section}>
            ...
            <h3>ポリゴンエクスポート</h3>
            <p>
              <strong>GeoJSON/KML形式</strong>で出力。他のGISツールやGoogle
              Earthで読み込み可能。
            </p>

            <h3>フルバックアップ</h3>
            <p>
              すべてのデータ（ポリゴン、Waypoint）を1つのJSONファイルに保存。
            </p>
          </div>
        )
          ...
          <div className={styles.section}>
            ...
            <table className={styles.shortcutTable}>
              <tbody>
                ...
                <tr>
                  <td>
                    <kbd>Cmd/Ctrl</kbd> + <kbd>/</kbd> または <kbd>?</kbd>
                  </td>
                  <td>ヘルプを開く / 閉じる</td>
                </tr>
                <tr>
