 ...
 */
export default function FlightPlanChecker({
  lat,
  lng,
  darkMode = false,
  compact = false,
  ...
  return (
    <div
      className={`${styles.container} ${darkMode ? styles.dark : ''} ${compact ? styles.compact : ''}`}>
      {/* メインステータス */}
      <div className={styles.mainStatus} style={{ borderColor: statusColor }}>
        <StatusIcon size={compact ? 24 : 32} style={{ color: statusColor }} />
