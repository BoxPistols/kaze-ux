...
const GridSettingsDialog = ({ polygon, onConfirm, onCancel }) => {
  ...
  const estimatedCount = useMemo(() => {
    ...
    const vertexCount = includeVertices
        ...
        <div className={styles.settingGroup}>
          ...
          <div className={styles.spacingInput}>
            <input
              ...
              value={spacing}
              onChange={(e) =>
                setSpacing(Math.max(5, parseInt(e.target.value) || 5))
              }
        ...
        <div className={styles.preview}>
          ...
          <div className={styles.countGrid}>
            ...
            <div className={`${styles.countItem} ${styles.total}`}>
              ...
              <span
                className={`${styles.countValue} ${isVeryHighCount ? styles.danger : isHighCount ? styles.warning : ''}`}>
