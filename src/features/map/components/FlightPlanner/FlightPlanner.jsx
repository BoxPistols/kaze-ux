          ...
          <div className='step-content'>
            ...
            {selectedUseCase && (
              <div className='usecase-details'>
                <h4>
                  {getIcon(selectedUseCase.icon, 16)} {selectedUseCase.name}
                </h4>
                <div className='detail-grid'>
                  ...
                  <div className='detail-item'>
                    <Plane size={14} />
                    <span>
                      推奨高度: {selectedUseCase.recommendedAltitude}m
                    </span>
                  </div>
                </div>
            ...
            <div className='step-actions'>
              ...
              <button
                ...
                disabled={
                  !selectedUseCase || !startPoint || !endPoint || isGenerating
                }>
                {isGenerating ? (
                  <>
        ...
        {step === 1 && (
          <div className='step-content'>
            ...
            <div className='point-inputs'>
              <div
                className={`point-input ${isSelectingStart ? 'selecting' : ''}`}>
                <label>
                  ...
                  <div className='point-search'>
                    <div className='search-input-wrapper'>
                      ...
                      <input
                        ...
                        onBlur={() =>
                          setTimeout(() => setIsSelectingStart(false), 200)
                        }
                        onChange={(e) => {
              ...
              <div
                className={`point-input ${isSelectingEnd ? 'selecting' : ''}`}>
                <label>
                  ...
                  <div className='point-search'>
                    <div className='search-input-wrapper'>
                      ...
                      <input
                        ...
                        onBlur={() =>
                          setTimeout(() => setIsSelectingEnd(false), 200)
                        }
                        onChange={(e) => {
          ...
          <div className='step-content'>
            ...
            <div className='route-cards'>
              {routeOptions.routes.map((route, idx) => {
                ...
                const isRecommended =
                  routeOptions.recommended?.name === route.name
                  ...
                  <div
                    ...
                    <div className='route-header'>
                      ...
                      <div className='route-score'>
                        <span
                          className={`score ${route.evaluation.score >= 70 ? 'good' : route.evaluation.score >= 40 ? 'warning' : 'bad'}`}>
