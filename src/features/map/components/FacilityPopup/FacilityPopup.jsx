...
const getZoneInfo = (zone) => {
  return (
    ZONE_INFO_MAP[zone] || { label: zone, color: '#6b7280', bgColor: '#f3f4f6' }
  )
}
...
const FacilityPopup = ({ facility, screenX, screenY, onClose }) => {
  ...
  const statusInfo = facility.operationalStatus
    ? getOperationalStatusInfo(facility.operationalStatus)
    : null
    ...
    <div
      ...
      <div className={styles.content}>
        ...
        <div className={styles.row}>
          ...
          <span className={styles.value}>
            {(facility.radiusKm * 1000).toFixed(0)}m
          </span>
        </div>
