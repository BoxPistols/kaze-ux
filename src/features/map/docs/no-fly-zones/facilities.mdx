...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <strong>廃炉作業中</strong> (decommissioning)
      </td>
      <td>🟡 黄</td>
      <td>
        <code>#eab308</code>
    ...
    <tr>
      <td>
        <strong>廃炉完了</strong> (decommissioned)
      </td>
      <td>⚪ 灰</td>
      <td>
        <code>#9ca3af</code>
