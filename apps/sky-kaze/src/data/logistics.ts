...
export const SHIPMENTS: Shipment[] = [
  {
    ...
    weight: 120,
    dimensions: '80x60x50',
    contents: '電子部品 積層セラミックコンデンサ 2,000個 / 抵抗器 5,000個',
    priority: 'express',
    cost: 45800,
    createdAt: daysAgo(2),
  ...
  },
  {
    ...
    contents: '冷凍食品（業務用餃子 50ケース / 冷凍うどん 30ケース）',
    priority: 'express',
    cost: 78500,
    createdAt: daysAgo(1),
  ...
  },
  {
    ...
    weight: 200,
    dimensions: '60x40x40',
    contents: '磁器 花瓶 30点 / 茶碗セット 50点 木箱梱包',
    priority: 'standard',
    cost: 38600,
    createdAt: daysAgo(3),
  ...
  },
  {
    ...
    weight: 80,
    dimensions: '50x40x30',
    contents: 'ラックサーバー 2U 2台 / 無停電電源装置 1台',
    priority: 'express',
    cost: 63500,
    createdAt: daysAgo(4),
  ...
  },
  {
    ...
    contents: '補修用ブレーキパッド 500セット / オイルフィルター 300個',
    priority: 'standard',
    cost: 42300,
    createdAt: daysAgo(2),
    estimatedDelivery: daysLater(1),
  ...
  },
  {
    ...
    weight: 60,
    dimensions: '40x30x20',
    contents: '特注磁器花瓶「月白」6点 / 香炉 3点 桐箱入り',
    priority: 'standard',
    cost: 33200,
    createdAt: daysAgo(3),
    estimatedDelivery: daysLater(1),
